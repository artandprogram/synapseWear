...
class CommonFunction {
    ...
    // MARK: mark - TodayExtension methods

    static let keyForTodayExtension: String = "group.com.artandprogram.sW"

    static func readForTodayExtension() -> UserDefaults? {

        return UserDefaults(suiteName: self.keyForTodayExtension)
    }

    static func saveForTodayExtension(co2: Int?, battery: Float?, temp: Float?, humidity: Int?, pressure: Float?, graphData: [Any]) {
